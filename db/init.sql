...
CREATE IF NOT EXISTS UNIQUE INDEX id_idx ON users(id);
...
CREATE UNIQUE INDEX id_idx ON tasks(id);
...
CREATE IF NOT EXISTS UNIQUE INDEX task_id_idx ON completed_tasks(task_id);
CREATE IF NOT EXISTS UNIQUE INDEX user_id_idx ON completed_tasks(user_id);
